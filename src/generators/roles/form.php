...
echo $form->field($generator, 'savedForm')->dropDownList(
    ...
    echo $form->field($generator, 'roleName');
    echo $form->field($generator, 'roleType')->dropDownList([
        \schmunk42\giiant\generators\roles\Generator::TYPE_USER => 'User',
        \schmunk42\giiant\generators\roles\Generator::TYPE_COMPANY => 'Company'
    ]);
    echo $form->field($generator, 'roleLabel');
